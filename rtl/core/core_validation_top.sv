...
//  output logic [DATA_W-1:0] debug_rs1_val[NUM_TEST_LANES-1:0],
//  output logic [DATA_W-1:0] debug_rs2_val[NUM_TEST_LANES-1:0],
//  output logic [DATA_W-1:0] debug_w_data[NUM_TEST_LANES-1:0]
);
  ...
  generate
    for (i = 0; i < NUM_TEST_LANES; i++) begin : lane_loop
      lane lane_inst (
          ...
          .mem_addr(mem_addr[i])
//        .debug_rs1_val(debug_rs1_val[i]),
//        .debug_rs2_val(debug_rs2_val[i]),
//        .debug_w_data(debug_w_data[i])
      );
    end
  endgenerate
